  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-center">
        <b-card class="text-center">
            <br>
            <h2><b-icon-star-fill variant="warning"></b-icon-star-fill> 별점 Top3</h2>
            <br>
...
export default {
    ...
    created() {
        this.$store.dispatch("getGymStar")
    },
    computed: {
        ...mapState(['gymStar'])
    },
    ...
    methods: {
      ...
      loadMap() {
        ...
        this.gymStar.forEach(function(addr, index) {
