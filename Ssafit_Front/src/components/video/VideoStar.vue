<template>
  <div class="container">
    <div class="row">
      <h3><b-icon-star-fill variant="warning"></b-icon-star-fill> 별점 Top 3 영상</h3>
      <b-button class="col-1 mb-2 mx-3" variant="outline-primary" @click="starVideo"><b-icon-hand-index-thumb></b-icon-hand-index-thumb></b-button>
        <b-row cols="1" cols-sm="2" cols-md="4">
            <b-card v-for="(video, index) in starVideos" :key="index"      
